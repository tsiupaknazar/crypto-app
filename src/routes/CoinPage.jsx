    ...
    return (
      <div className='rounded-div my-12 py-8'>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          ...
          <div>
            ...
            <div className='flex justify-between py-4'>
              ...
              <div>
                <p className='text-gray-500 text-sm'>Price Change (1year)</p>
        ...
        <div className='py-4'>
          ...
          <p dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(coin.description ? coin.description.en : "No description"), }}></p>
        </div>
      </div>
    )
  }
